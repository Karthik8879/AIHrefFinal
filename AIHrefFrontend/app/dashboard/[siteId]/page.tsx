          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="font-semibold text-green-600">{analytics.topPages.length}</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-gray-600">Countries</span>
                <span className="font-semibold text-purple-600">{analytics.topCountries.length}</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-gray-600">Data Source</span>
                <span className="font-semibold text-orange-600">
                  {dataSource === 'realtime' ? '⚡ Real-time' : '📊 Aggregated'}
                </span>
              </div>
              <div className="flex justify-between items-center">
                ...
                <div className="text-right">
                  ...
                  {analytics?.lastUpdated && (
                    <div className="text-xs text-gray-400">
                      {(() => {
                        const now = new Date();
                        const updated = new Date(analytics.lastUpdated);
